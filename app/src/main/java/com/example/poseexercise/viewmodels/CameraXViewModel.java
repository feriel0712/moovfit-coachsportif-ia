...
public final class CameraXViewModel extends AndroidViewModel {
    ...
    private final MutableLiveData<PostureFeedback> postureFeedbackLiveData = new MutableLiveData<>();

    public MutableLiveData<Map<String, PostureResult>> getPostureLiveData() {
        return postureLiveData;
    }

    public MutableLiveData<PostureFeedback> getPostureFeedbackLiveData() {
        return postureFeedbackLiveData;
    }
